                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6">
                            ...
                            <div class="kt-portlet__body kt-portlet__body--fluid">
                                <div class="kt-widget26">
                                    <div class="kt-widget26__content">
                                        ...
                                        <span class="kt-widget26__desc">Account No: <b>{{ auth()->user()->wallet->account_number }}</b></span>
                                    </div>
                        ...
                        <div class="kt-portlet kt-portlet--height-fluid-half kt-portlet--border-bottom-danger">
                            <div class="kt-portlet__body kt-portlet__body--fluid">
                                <div class="kt-widget26">
                                    <div class="kt-widget26__content">
                                        <span class="kt-widget26__number">{{ count($transactions) }}</span>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        <div class="kt-portlet kt-portlet--height-fluid-half kt-portlet--border-bottom-success">
                            <div class="kt-portlet__body kt-portlet__body--fluid">
                                <div class="kt-widget26">
                                    <div class="kt-widget26__content">
                                        <span class="kt-widget26__number">₦ {{ auth()->user()->wallet->savings_balance }}</span>
                                        <span class="kt-widget26__desc">Savings balance</span>
                                    </div>
                                    <div class="kt-widget26__chart" style="height:100px; width: 230px;">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="kt-widget11__title">{{ $transaction->trasaction_code }}</span>
                                                    </td>
                                                    <td>{{ $transaction->type }}</td>
                                                    <td>

                                                    </td>
                                                    <td><span class="kt-badge kt-badge--danger kt-badge--inline">{{ $transaction->status }}</span></td>
