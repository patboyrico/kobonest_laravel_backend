...
@section('title', 'Agent Register User')
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form kt-form--label-right" method="POST" action="{{route('agent.post.register.user')}}">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input class="form-control" name="password_confirmation" placeholder="Enter Password Confirmation" />
