                    ...
                    <table class="kt-datatable__table" style="display: block;">
                        <thead class="kt-datatable__head"><tr class="kt-datatable__row" style="left: 0px;">
                            ...
                            <th data-field="Country" class="kt-datatable__cell kt-datatable__cell--sort">
                                <span style="width: 110px;">Savings Type</span>
                            </th>
                        ...
                        @forelse ($savings as $saving)
                            <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                                <td data-field="OrderID" class="kt-datatable__cell">
                                    <span style="width: 110px;">{{$saving->user->full_name}}</span>
                                </td>
                                <td data-field="Country" class="kt-datatable__cell">
                                    <span style="width: 110px;">{{ $saving->amount }}</span>
                                </td>
                                <td data-field="CompanyName" class="kt-datatable__cell">
                                    <span style="width: 110px;">{{ $saving->saving_type }}</span>
                                </td>
                                <td data-field="ShipDate" class="kt-datatable__cell">
                                    <span style="width: 110px;">{{ $saving->category->name }}</span>
                                </td>
                                <td data-field="CompanyName" class="kt-datatable__cell">
                                    <span style="width: 110px;">{{ $saving->maturity_period }} years</span>
                                </td>
                            </tr>
                        @empty

                            <div class="container" style="text-align:center">
                                <span> No Recent Savings Yet </span>
                            </div>
