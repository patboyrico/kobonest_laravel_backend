                        ...
                        @forelse ($deposits as $deposit)
                            <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                                ...
                                <td data-field="OrderID" class="kt-datatable__cell">
                                    <span style="width: 110px;">{{$deposit->transaction->id}}</span>
                                </td>
                                <td data-field="Country" class="kt-datatable__cell">
                                    <span style="width: 110px;">{{ $deposit->amount }}</span>
                                </td>
                                <td data-field="ShipDate" class="kt-datatable__cell">
                                    <span style="width: 110px;">{{ $deposit->deposit_type }}</span>
                                </td>
                                <td data-field="CompanyName" class="kt-datatable__cell">
                                    <span style="width: 110px;">{{ $deposit->category->name }}</span>
                                </td>
                            </tr>
                        @empty

                            <div class="container" style="text-align:center">
                                <span> No Recent Deposits Yet </span>
                            </div>
