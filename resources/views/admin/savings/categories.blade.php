...
@section('title', 'Savings Categories')
            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <a href="{{ route('admin.saving.category.add') }}" class="btn btn-brand btn-icon-sm" aria-haspopup="true" aria-expanded="false">
                    ...
                    <table class="kt-datatable__table" style="display: block;">
                        <thead class="kt-datatable__head"><tr class="kt-datatable__row" style="left: 0px;">
                            ...
                            <th data-field="Country" class="kt-datatable__cell kt-datatable__cell--sort">
                                <span style="width: 110px;">Description</span>
                            </th>
                    ...
                    <tbody class="kt-datatable__body" style="">
                        @forelse ($categories as $category)
                            <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                                ...
                                <td data-field="Country" class="kt-datatable__cell">
                                    <span style="width: 110px;">{{ $category->description }}</span>
                                </td>
                        ...
                        @empty
                            ...
                            <div class="container" style="text-align:center">
                                <span> No Recent Savings Categories Added Yet </span>
                            </div>
