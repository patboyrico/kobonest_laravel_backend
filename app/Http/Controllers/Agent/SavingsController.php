...
class SavingsController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('agent.savings.index', $this->data);
    }

    public function makeSavingsPage()
    {
        $this->categories = SavingsCategory::all();
        return view('agent.savings.make', $this->data);
    }
    ...
    public function makeSaving(Request $request)
    {
        ...
        return redirect()->route('agent.dashboard')->with('success', 'Savings Set Up Successfully');
