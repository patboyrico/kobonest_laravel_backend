...
class DepositController extends BaseController
{
    ...
    public function makeDeposit(Request $request)
    {
        ...
        return redirect()->route('user.dashboard')->with('success', 'Deposit Set Up Successfully');
    }
