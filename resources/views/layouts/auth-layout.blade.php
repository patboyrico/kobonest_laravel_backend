...
<html lang="en">
	...
	<head>
		...
		<meta name="description" content="Kobonest User Accounts">
		...
		<link href="{{ asset('plugins/general/owl.carousel/dist/owl.carousel.css')}}" rel="stylesheet" type="text/css" />
		<link href="{{ asset('plugins/general/owl.carousel/dist/owl.theme.default.css')}}" rel="stylesheet" type="text/css" />
