                ...
                <div class="kt-login__container">
                    ...
                    <div class="kt-login__signin">
                        <div class="kt-login__head">
                            <h3 class="kt-login__title" style="color: white;">Sign Up For A Kobonest Account</h3>
                        </div>
                        @if($errors->any())
                        ...
                        @endif
                        <form class="kt-form" action="{{ route('user.post.register') }}" method="POST">
                            @csrf
                            <div class="">
                    ...
                    <div class="kt-login__account">
                        ...
                        &nbsp;&nbsp;
                        <a href="{{ route('user.login') }}"  class="kt-login__account-link">Sign In!</a>
                    </div>
                </div>
            </div>
        </div>
