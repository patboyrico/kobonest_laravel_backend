                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6">
                            ...
                            <div class="kt-portlet__body kt-portlet__body--fluid">
                                <div class="kt-widget26">
                                    <div class="kt-widget26__content">
                                        <span class="kt-widget26__number">₦{{$total_income}}</span>
                                        <span class="kt-widget26__desc">Total Income</b></span>
                                    </div>
                        ...
                        <div class="kt-portlet kt-portlet--height-fluid-half kt-portlet--border-bottom-danger">
                            <div class="kt-portlet__body kt-portlet__body--fluid">
                                <div class="kt-widget26">
                                    <div class="kt-widget26__content">
                                        <span class="kt-widget26__number">{{count($users)}}</span>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        <div class="kt-portlet kt-portlet--height-fluid-half kt-portlet--border-bottom-success">
                            <div class="kt-portlet__body kt-portlet__body--fluid">
                                <div class="kt-widget26">
                                    <div class="kt-widget26__content">
                                        <span class="kt-widget26__number">{{count($agents)}}</span>
                                        <span class="kt-widget26__desc">Total Agents</span>
                                    </div>
                                    <div class="kt-widget26__chart" style="height:100px; width: 230px;">
                        ...
                        <div class="kt-portlet kt-portlet--height-fluid-half kt-portlet--border-bottom-warning">
                            <div class="kt-portlet__body kt-portlet__body--fluid">
                                <div class="kt-widget26">
                                    <div class="kt-widget26__content">
                                        <span class="kt-widget26__number">₦{{$paid_out}}</span>
                                        <span class="kt-widget26__desc">Amount Paid Out</span>
                                    </div>
                                    <div class="kt-widget26__chart" style="height:100px; width: 230px;">
                            ...
                            <div class="tab-pane active" id="kt_widget11_tab1_content">
                                ...
                                <div class="kt-widget11">
                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td style=" width: 10%;" class="kt-align-right">Account Number</td>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="kt-widget11__title">{{ $user->full_name }}</span>
                                                        </td>
                                                        <td>{{ $user->phone_number }}</td>
                                                        <td>{{ $user->email }} </td>
                                                        <td  class="kt-align-right">{{ $user->wallet->account_number }} </td>
                                    ...
                                    <div class="kt-widget11__action kt-align-right">
                                        <button type="button" class="btn btn-label-success btn-sm btn-bold">View All Users</button>
                                    </div>
                                </div>
