                ...
                <div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--loaded" id="local_data" style="">
                    <table class="kt-datatable__table" style="display: block;">
                        <thead class="kt-datatable__head"><tr class="kt-datatable__row" style="left: 0px;">
                            ...
                            <th data-field="OrderID" class="kt-datatable__cell kt-datatable__cell--sort">
                                <span style="width: 110px;">Transfer ID</span>
                            </th>
                    ...
                    <tbody class="kt-datatable__body" style="">
                        ...
                        <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                            ...
                            <td data-field="OrderID" class="kt-datatable__cell kt-datatable__cell--sort">
                                <span style="width: 110px;">{{ $transfer->id }}</span>
                            </td>
                            <td data-field="OrderID" class="kt-datatable__cell kt-datatable__cell--sort">
                                <span style="width: 110px;">{{ $transfer->to }}</span>
                            </td>
                            <td data-field="OrderID" class="kt-datatable__cell kt-datatable__cell--sort">
                                <span style="width: 110px;">{{ $transfer->amount }}</span>
                            </td>
                        </tr>
                        @empty
                          <div class="container" style="text-align:center">
                            <span> No Recent Transfers Yet </span>
                          </div>
                        @endforelse
                    </tbody>
                </table>
